...
public class GraphStepActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_graph_step);
...
//        });
    ...
    protected void onStart() {
        ...
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("GraphStep");
...
//                    graphView.getViewport().setMaxY(6);
                   ...
                   // long i= Integer.parseInt(g.getDate());
                    dp[index]=new DataPoint(arr++,g.getSteps());
                    index+=1;
                    //arr=arr+1;
                }
