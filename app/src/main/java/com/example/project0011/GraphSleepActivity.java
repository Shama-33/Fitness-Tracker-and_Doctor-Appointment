...
public class GraphSleepActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        graphView= (GraphView) findViewById(R.id.graphsleeptime);
    ...
    protected void onStart() {
        ...
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("UserDataAll").child("Sleep");
...
//                    graphView.getViewport().setMaxY(6);
                    ...
                    String s=ds.child("hour").getValue().toString();
